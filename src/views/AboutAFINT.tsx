...
// ── Typographic scale (applied consistently across this page) ─────────────────
// Page section heading : text-3xl md:text-4xl  font-bold   serif
// Sub-heading          : text-2xl              font-bold   serif
// Card heading         : text-base             font-semibold
// Body lead            : text-base             leading-relaxed  stone-600
// Body supporting      : text-sm               leading-relaxed  stone-500
// Label / eyebrow      : text-xs uppercase tracking-widest font-bold amber-700
// ─────────────────────────────────────────────────────────────────────────────
        ...
        <section className="py-24 px-6 bg-white border-b border-stone-200">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-16 items-start pb-14 mb-14 border-b border-stone-200">
              ...
              {/* Quote col — now matches the mission heading scale */}
              <div className="md:col-span-9">
                <h2
                  className="text-3xl md:text-4xl font-bold text-stone-900 leading-snug"
                  style={{ fontFamily: "Playfair Display, serif" }}
                >
                  To provide a biblically faithful, academically rigorous, and
                  spiritually transformative English translation of the New
            ...
            {/* ── Mission header ── */}
            <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6 mb-8">
              {/* Mission heading — same scale as vision heading */}
              <h3
                className="text-3xl md:text-4xl font-bold text-stone-900 shrink-0"
                style={{ fontFamily: "Playfair Display, serif" }}
              >
                Our Mission Statement
              </h3>
              <p className="text-base text-stone-500 leading-relaxed max-w-xl md:text-right">
                To honor Christ and strengthen the Church by producing a
                reliable, accurate, and readable English translation of the
                Greek New Testament, designed for study, teaching, preaching,
                and spiritual formation.
              ...
              {missionPoints.map((point, idx) => (
                ...
                >
                  <div className="bg-white p-7 group hover:bg-stone-50 transition-colors duration-200 relative h-full">
                    ...
                    {/* Card heading — text-base, consistent across all cards */}
                    <h4 className="text-base font-semibold text-stone-800 mb-2 leading-snug group-hover:text-amber-700 transition-colors duration-200 pr-6">
                      {point.title}
                    </h4>
        ...
        <section className="py-24 px-6 bg-stone-100">
          <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16">
            <div className="lg:col-span-7 space-y-5 text-stone-700">
              ...
              {/* Section heading — consistent with all other section headings */}
              <h2
            ...
            <div className="lg:col-span-5 relative">
              <div className="sticky top-10 bg-amber-700 text-amber-50 p-10 rounded-sm shadow-2xl">
                <Layers className="text-amber-400 mb-6" size={40} />
                {/* Sidebar heading — text-2xl, one step below section headings */}
                <h4
                  className="text-2xl font-bold mb-4 text-white"
                  style={{ fontFamily: "Playfair Display, serif" }}
                >
                ...
                <p className="text-base mb-4 leading-relaxed font-semibold text-white">
                  The AFINT is not an Africanized version of Scripture but an
                  academically rigorous work produced under the leadership of
                  African theologians and exegetes.
                </p>
      ...
      <section className="py-24 px-6 bg-white border-y border-stone-200">
        <div className="max-w-6xl mx-auto">
          <AnimateOnScroll animation="fade-up">
            <div className="text-center mb-16">
              ...
              <p className="text-base text-stone-600 max-w-3xl mx-auto leading-relaxed">
                The AFINT is a carefully structured translation project built on
                a dual-layer philosophy. These two components function in
                deliberate relationship: the Explanatory Paraphrase is
                consistently based on, derived from, and governed by the Literal
                Translation, ensuring all interpretive expansion maintains
                accuracy, integrity, and accountability to the original Greek
                text.
              </p>
            </div>
          </AnimateOnScroll>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 border border-stone-200 rounded-sm overflow-hidden shadow-sm">
            {/* Layer 1 */}
            <AnimateOnScroll animation="zoom-in" delay={100}>
              <div className="bg-stone-50 p-10 lg:border-r border-stone-200 h-full">
                <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-stone-200 text-stone-600 font-bold mb-6">
                  1
                </div>
                {/* Panel heading — text-2xl */}
                <h3
                  className="text-2xl font-bold text-stone-900 mb-2"
                  style={{ fontFamily: "Playfair Display, serif" }}
                >
                ...
                {/* Panel sub-label — text-base, amber */}
                <p className="text-base font-semibold text-amber-700 mb-5">
                  The Foundation of Accuracy and Integrity
                </p>
                ...
                <ul className="space-y-4 text-stone-700">
                  {[
                    [
                      ...
                      "Preserves grammatical structure and syntactical relationships.",
                    ],
                    [
                      "Lexical precision",
                      "Careful attention to semantic range and conceptual continuity.",
                    ],
                    ["Minimal expansion", "Focus is on what the text says."],
                    [
                      "Transparency",
                      "Suitable for serious study and comparison.",
                    ],
                  ].map(([label, detail], i) => (
              ...
              <div className="bg-white p-10 h-full">
                ...
                <ul className="space-y-4 text-stone-700">
                  {[
                    [
                      "Derived directly",
                      "Rooted in the wording established in the AFINT Literal.",
                    ],
                    [
                      "Explanatory expansions",
                      "Unpacks compressed expressions and illuminates context.",
                    ],
                    [
                      "Exegetical integration",
                      "Incorporates grammatical and theological insights.",
                    ],
                    [
                      "Guided clarity",
                      "Provides reasoned and textually grounded explanation.",
                    ],
                  ].map(([label, detail], i) => (
                    <li key={i} className="flex gap-3">
                      <ChevronRight
      ...
      <AnimateOnScroll animation="fade-up">
        <section className="py-24 px-6 bg-stone-900 text-stone-300">
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-20 pb-20 border-b border-stone-700">
              <div>
                {/* Sub-heading — text-2xl, consistent with all other sub-headings */}
                <h3
                  className="text-2xl font-bold text-white mb-6"
                  style={{ fontFamily: "Playfair Display, serif" }}
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {purposes.map((purpose, idx) => (
                ...
                >
                  <div className="bg-stone-800 border border-stone-700 p-6 rounded-sm hover:border-amber-500 transition-colors h-full">
                    {/* Purpose card heading — text-base, consistent with mission cards */}
      ...
      <AnimateOnScroll animation="zoom-in">
        <section className="bg-amber-700 text-white py-16 px-6 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-base text-amber-100 leading-relaxed mb-8">
              A reliable tool for evangelism, theological education, leadership
              training, and spiritual formation. Discover the depth of God's
              Word through the lens of African scholarship.
            </p>
