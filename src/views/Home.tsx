...
const ministries = [
  ...
  },
  {
    ...
    icon: <PenTool size={36} className="text-primary" />,
  },
  {
  ...
  },
  {
    ...
    icon: <HandHeart size={36} className="text-primary" />,
  },
  {
    name: "Gospel Mission",
    ...
    <main className="overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto">
          <AnimateOnScroll animation="fade-up">
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl md:text-5xl font-bold text-on-surface mb-4 font-headline italic">
              ...
              <p className="text-outline text-lg max-w-3xl mx-auto leading-relaxed">
                Word Biblical Ministries (WBM) exists to contribute to the
                fulfillment of the Great Commission through prayer, faithful
                Bible translation, and rigorous exegetical work.
              </p>
            </div>
          </AnimateOnScroll>
            ...
            {highlights.map((h, i) => (
              ...
              >
                <div className="bg-white rounded-sm p-7 shadow hover:shadow-lg transition-all duration-300 border-b-4 border-amber-600 group h-full">
                  ...
                  <h3 className="text-lg font-bold text-on-surface mb-2 font-headline italic">
                    {h.title}
                  </h3>
          ...
          >
            <Link
              href="/about-wbm"
              className="inline-flex items-center gap-2 text-surface-tint hover:text-primary font-bold text-sm uppercase tracking-widest border-b-2 border-amber-600 pb-1 transition-colors"
            >
      ...
      <section className="relative py-28 px-6 text-white overflow-hidden">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-6 font-headline italic">
            About AFINT
          </h2>
          <div className="flex items-center justify-center gap-3 my-5">
            <div className="h-px w-16 bg-amber-400" />
          ...
          <p className="text-inverse-on-surface text-lg leading-relaxed mb-10 max-w-2xl mx-auto">
          ...
          <Link
            href="/about-afint"
            className="border-2 border-amber-500 hover:bg-primary hover:border-amber-600 text-white font-bold text-sm uppercase tracking-widest px-8 py-4 rounded-sm transition-all duration-200 inline-flex items-center gap-2"
          >
        ...
        <div className="max-w-6xl mx-auto">
          <AnimateOnScroll animation="fade-up">
            <div className="text-center mb-16">
              ...
              <p className="text-outline text-lg max-w-xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {ministries.map((m, i) => (
              <AnimateOnScroll
                ...
                delay={(i * 100) as any}
              >
                <div className="bg-white p-7 rounded-sm shadow hover:shadow-xl border-l-4 border-amber-600 transition-all duration-300 group hover:-translate-y-2 cursor-pointer h-full">
                  <div className="mb-4 transform transition-transform group-hover:scale-110 origin-left flex justify-start">
                    {m.icon}
                  </div>
