...
export default function PageHero({
  ...
  return (
    <section className={`relative pt-40 pb-24 px-6 ${bgClass} text-white`}>
      ...
      <div className="absolute inset-0 bg-linear-to-b from-stone-950/60 to-stone-950/80" />
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        {tag && (
          <p className="text-primary-container text-xs uppercase tracking-widest font-bold mb-4 font-label">
            {tag}
          </p>
        )}
