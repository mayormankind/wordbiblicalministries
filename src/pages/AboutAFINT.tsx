...
//               </h3>
//               <p className="mb-4">
//                 The defining feature of the AFINT translation philosophy is the
//                 dependence of the Explanatory Paraphrase on the Literal
//                 Translation, ensuring:
//               </p>
//               <ul className="space-y-2 mb-6">
//                 <li>
//                   <strong className="text-amber-500">Accuracy</strong> –
//                   Interpretation remains anchored in a formally controlled base.
//                 </li>
//                 <li>
//                   <strong className="text-amber-500">Integrity</strong> – The
//                   meaning is not altered or detached from the original wording.
//                 </li>
//                 <li>
...
//                     Testament: <span className="text-stone-500 text-xs"></span>
//                   </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6 mb-8">
            ...
            <p className="text-stone-500 text-base leading-relaxed max-w-xl md:text-right">
              To honor Christ and strengthen the Church by producing a reliable,
              accurate, and readable English translation of the Greek New
              Testament, designed for study, teaching, preaching, and spiritual
              formation.
            </p>
          </div>
          ...
          >
            {missionPoints.map((point, idx) => (
              <div
                key={idx}
                className={`bg-white p-7 group hover:bg-stone-50 transition-colors duration-200 relative${
              ...
              <div className="bg-stone-800 p-6 rounded-sm border border-stone-700 flex items-start gap-4">
                ...
                <div>
                  ...
                  <ul className="text-sm list-disc ml-4 mt-2">
                    ...
                    <li>The Greek New Testament, 5th Revised Edition (UBS5)</li>
                  </ul>
                </div>
              </div>
            </div>
