...
//   },
//   {
//     icon: <Handshake size={36} className="text-amber-600" />,
...
//   },
//   {
//     icon: <Wrench size={36} className="text-amber-600" />,
...
//   },
//   {
//     icon: <Sparkles size={36} className="text-amber-600" />,
...
//                   strengthen the Church, and contribute to the fulfillment of
//                   the Great Commission through prayer, faithful Bible
//                   translation, and rigorous exegetical work.
//                 </p>
//                 <p>
//                   Based in Akure, Nigeria, WBM is committed to producing
//                   accurate New Testament translations and developing scholarly
//                   yet practical commentaries that shape believers in Christlike
//                   maturity.
//                 </p>
//                 <p>
//                   We uphold the authority and sufficiency of Scripture,
//                   defending historic evangelical doctrine while equipping the
//                   global Body of Christ for mission and discipleship.
//                 </p>
//               </div>
//             </div>
...
//                       Following Acts 6:4, we devote ourselves first to prayer
//                       and intercession, believing that all effective
//                       proclamation of God's Word must flow from dependence on
//                       the Holy Spirit and persevering prayer.
//                     </p>
//                   </div>
//                 </AnimateOnScroll>
...
//                   <div>
//                     <h4 className="font-bold text-lg">
//                       3. Exegetical and Pastoral New Testament Commentary
//                       Writing
//                     </h4>
//                     <p className="text-amber-100/90 mt-1 leading-relaxed">
...
//                 delay={(i * 100) as any}
//               >
//                 <div className="bg-stone-50 p-7 rounded-sm border border-stone-200 hover:border-amber-400 hover:shadow-md transition-all duration-300 flex flex-col h-full">
