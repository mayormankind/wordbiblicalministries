    ...
    <main>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2
            className="text-3xl md:text-4xl font-bold text-stone-800 mb-5"
          ...
          <p className="text-stone-600 text-lg leading-relaxed">
            At WBM, we believe every member of the Body of Christ has a role to
            play. Our various ministries are designed to meet people where they
            are, develop their gifts, and deploy them for Kingdom impact.
      ...
      <section className="pb-24 px-6 bg-stone-50">
        <div className="max-w-6xl mx-auto space-y-10">
          {ministriesList.map((m, i) => (
            <div
              key={i}
              className={`bg-white rounded-sm shadow-sm hover:shadow-md transition-all duration-300 border-l-8 ${m.color} overflow-hidden`}
            >
              <div className="p-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div>
                  <h4 className="font-bold text-stone-700 text-sm uppercase tracking-widest mb-4">
                    What We Offer
                  </h4>
      ...
      <section className="py-16 px-6 bg-amber-700 text-white text-center">
        ...
        <p className="text-amber-100 mb-8 max-w-xl mx-auto">
          Contact us to learn more about any of our ministries, or come visit us
